...
public class DBUtils {
    ...
    public static void destroy() { //tearDown
        try {
            ...
            System.out.println("DB had DESTROYED");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public static List<List<Object>> getQueryResultList(String query) {
        ...
        try {
            ...
            while (resultSet.next()) { // tum satirlari sirayla donecek!!

                List<Object> row = new ArrayList<>();
                for (int i = 1; i <= rsmd.getColumnCount(); i++) { // her bir kolon degerini al ve listeye ekle!
